...
if(!payslip) return <p className='text-center py-12 text-slate-400'>Payslip not found</p>
  ...
  return (
    <div className='max-w-2xl mx-auto p-8 bg-white animate-fade-in'>
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        ...
        <div>
          <p className='text-xs text-slate-400 uppercase
           tracking-wider mb-1'>
            Position</p>  
          <p className='font-semiblod text-slate-900'>{payslip.employee?.position} 
            </p>        
        </div>
        ...
        <div>
          <p className='text-xs text-slate-400 uppercase
           tracking-wider mb-1'>
            Email</p>  
          <p className='font-semiblod text-slate-900'>{payslip.employee?.email} 
            </p>        
        </div>
        ...
        <div>
          <p className='text-xs text-slate-400 uppercase
           tracking-wider mb-1'>
            Period</p>  
          <p className='font-semiblod text-slate-900'>{format(new Date(payslip.year, payslip.month - 1), "MMMM yyyy")} 
            </p>        
        </div>
        ...
        <table className='w-full'>
          <thead>
            <tr className='bg-slate-50'>
              ...
              text-xs text-slate-500 uppercase tracking-wider'>Description</th>
              <th className='text-right py-3 px-4 
              text-xs text-slate-500 uppercase tracking-wider'>Amount</th>               
              </tr>            
          </thead>
          <tbody>
      ...
      <button  className='btn-primary print:hidden'
