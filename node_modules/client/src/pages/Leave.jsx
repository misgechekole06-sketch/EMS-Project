...
const Leave = () => {
  ...
  return (  
    <div className="animate-fade-in">
          ...
          {leaveStats.map((s)=>(
            ...
            items-center gap-4 relative overflow-hidden group">
              ...
              <div> 
                ...
                <p className="text-2xl font-bold text-slate-900">{s.value} <span className="text-sm font-normal
      ...
      <LeaveHistory leaves={leaves} isAdmin={isAdmin} 
      onUpdate={fetchLeaves}/>
      <ApplyLeaveModal open={showModal} onClose={()=> 
        setShowModal(false)} onSuccess={fetchLeaves}/>
