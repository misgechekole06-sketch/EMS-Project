...
const Leave = () => {
  ...
  const fetchLeaves = useCallback(async () => {
    ...
    try {
      ...
      console.error("Leave fetch error details:", error.response);
      const errorMessage = error?.response?.data?.error || "Could not load leave records";
