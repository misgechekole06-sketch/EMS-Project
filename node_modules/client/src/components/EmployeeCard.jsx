    ...
    <div className="group relative card card-hover overflow-hidden">
      ...
      <div className="absolute top-3 left-3 flex gap-2">
        <span 
          ...
          className="bg-white/90 backdrop-blur-sm px-2.5 py-1 text-xs font-semibold text-slate-600 rounded-lg shadow-sm cursor-pointer"
        >
          {employee.department || "General"}
        </span>
        {isInactive && (
          <span className="bg-red-500/60 text-white px-2.5 py-1 text-xs rounded font-medium">
            Inactive
          </span>
        )}
      </div>
