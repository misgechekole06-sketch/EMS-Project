...
const LoginLeftSide = () => {
 ...
 <div className="absolute top-[-7.5rem] left-[-7.5rem] w-72 h-72 bg-indigo-500/20 rounded-full blur-3xl">
    </div>
    ...
    <div className="relative z-10 flex flex-col items-start justify-center p-12 lg:p-20 w-full h-full">
        ...
        <p className="text-slate-400 text-lg max-w-md leading-relaxed">
          Control your workflow operations, track attendance, and manage your team efficiently.</p>
    </div>
    </div> 
  )
}
