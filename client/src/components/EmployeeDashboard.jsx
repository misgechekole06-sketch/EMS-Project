...
import { ArrowRightIcon, CalendarIcon, FileTextIcon, DollarSignIcon} from 'lucide-react';
         ...
         mb-8">
            {cards.map((card, index) => (
                ...
                relative overflow-hidden group flex items-center justify-between">
                    ...
                    <card.icon className="size-10 p-2.5 rounded-lg 
