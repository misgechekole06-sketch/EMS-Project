...
const LoginLanding = () => {
  ...
  const portalOptions = [
    { 
      to: '/login/admin',
      title: 'Admin Portal',
      description: 'Access the admin dashboard to manage employees, view reports, and configure system settings.',
      icon: 'ShieldIcon'
    },
    { 
      to: '/login/employee',
      title: 'Employee Portal',
      description: 'Access your personal dashboard to view schedules, submit requests, and manage your profile.',
      icon: 'UserIcon'
    }
  ];
  return (
